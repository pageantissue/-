...
public class RegisterFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        phoneLabel.setBounds(49, 189, 95, 14);
        ...
        passwordLabel.setBounds(50, 227, 95, 14);
        getContentPane().add(passwordField);
        passwordField.setBounds(173, 220, 160, 20);
    ...
    private void registerButtonLabelClicked(MouseEvent evt) {
        ...
        if(phoneNumber.length() == 14 && phoneNumber.charAt(0) == '+') {
