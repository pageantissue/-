...
public class Database
{
   ...
   private static final String password = "ff2017";
   ...
   public static int uploadOrder(Order order) // returns orderId
   {
      ...
      try
      {
         String query = "INSERT INTO orders(userid, totalcost, isAccepted, comment, date) VALUES (?,?,?,?,?)";
         //uploading
         ...
         preparedStatement.setString(4, "not bad");
